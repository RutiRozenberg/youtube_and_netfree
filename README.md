...
להוספת קיושר לקטגוריה קיימת, יש להריץ את הסקריפט: addLinkData או add_link_data.

ליצירת קטגוריה חדשה והוספת קישור, יש להריץ את הסקריפט: createJsonData או create_json_data.

לבסוף, יש להפעיל את הסקריפט createOrUpdateReadme או create_or_update_readme לעדכון תצוגת הקישורים בקובץ Markdown.
